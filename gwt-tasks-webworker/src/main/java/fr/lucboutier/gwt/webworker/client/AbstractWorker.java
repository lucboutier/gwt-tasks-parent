...
public class AbstractWorker extends JavaScriptObject {
  ...
  public final native void setOnError(ErrorHandler handler) /*-{
    this.onerror = function(event) {
      @fr.lucboutier.gwt.webworker.client.AbstractWorker::onErrorImpl(Lfr/lucboutier/gwt/webworker/client/ErrorHandler;Lfr/lucboutier/gwt/webworker/client/ErrorEvent;)(handler, event);
    }
  }-*/;
